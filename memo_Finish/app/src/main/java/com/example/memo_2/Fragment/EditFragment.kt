...
class EditFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        with(binding) {
            ...
            if(list.contains(args.memo.no.toString())){

                bookmarkBtn.text = "즐찾취소"
            }else{
                bookmarkBtn.text = "즐찾하기"

            }


            bookmarkBtn.setOnClickListener {
                if( bookmarkBtn.text == "즐찾하기"){

                    myApp.prefs.addMemoToFavorites(args.memo.no.toString())
                    bookmarkBtn.text = "즐찾취소"
                }else{

                    myApp.prefs.removeMemoFromFavorites(args.memo.no.toString())
                    bookmarkBtn.text = "즐찾하기"
                }
